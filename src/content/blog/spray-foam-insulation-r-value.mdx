...
<StatsCard
  ...
  stats={[
    { value: "R-7.9", label: "Our Closed-Cell", description: "UPC 2.0 HFO High Lift" },
...
[Building Science Corporation](https://buildingscience.com/documents/guides-and-manuals/gm-2102-residential-spray-foam-guide) specifies that high-density closed-cell spray foam (2.0 lb/cubic foot) provides R-5.5 to R-6.5 per inch for aged R-value. However, **premium third-generation HFO formulations like UPC 2.0 HFO High Lift achieve R-7.9 per inch** — among the highest available.

<InfoBox title="Foamology Uses Premium R-7.9 Foam" variant="tip">
